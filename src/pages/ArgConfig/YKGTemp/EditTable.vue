        ...
        >
            ...
            <el-table-column prop="x" label="x" align="center">
                <template slot-scope="scope">
                    <el-input-number :controls="false" v-model="scope.row.x" @change="dataChange"></el-input-number>
                </template>
            </el-table-column>
            <el-table-column prop="f" label="f(x)" align="center">
                <template slot-scope="scope">
                    <el-input-number v-model="scope.row.f" :controls="false" @change="dataChange"></el-input-number>
                </template>
            </el-table-column>
            <el-table-column prop="PE" label="性质" align="center">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.PE" placeholder="请选择" @change="dataChange">
                        <el-option
                            v-for="item in [{id:'P',label:'P'}, {id:'E',label:'E'}]"
                            :key="item.id"
                            :label="item.label"
                            :value="item.id"
                        ></el-option>
