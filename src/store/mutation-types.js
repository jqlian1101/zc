...
// 清空数据
export const CLEAR_ALL_DATA_MODELS = 'CLEAR_ALL_DATA_MODELS';
...
// 清空数据
export const CLEAR_ALL_DATA_UISTATE = 'CLEAR_ALL_DATA_UISTATE';

// 保存元件定义状态，是否定义
export const MODEL_SAVE_DEFINED_ELE_STATUS = 'MODEL_SAVE_DEFINED_ELE_STATUS'

export const MODEL_INIT_ELE_STATUS = 'MODEL_INIT_ELE_STATUS'
